...
public class NotificationService {
    ...
    private static final String TWILIO_PHONE_NUMBER = dotenv.get("TWILIO_PHONE_NUMBER");

    public NotificationService() {
        if (ACCOUNT_SID == null || AUTH_TOKEN == null || TWILIO_PHONE_NUMBER == null) {
            throw new IllegalStateException("Twilio environment variables are not set properly in the .env file.");
        }
